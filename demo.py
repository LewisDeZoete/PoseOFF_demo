...
def video(video_path, alpha=1, first_x: int = 0):
    # TODO: Get this working for offline video processing...
    # Get the first frame
    ...
    if first_x > 0:
        ...
        norm_flow = get_norm_flows(img1, img2, alpha=alpha)
    ...
    if not first_x:
        while cap.isOpened():
            ...
            norm_flow = get_norm_flows(img1, img2)
